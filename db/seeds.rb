...
flights = [
  { destination: saved_locations['Lagos'], flight_date: 1.day.from_now, airport: saved_airports['Nnamdi Azikwe International Airport'], airline: saved_airlines['Asiana'], available_seats: 10 },
  { destination: saved_locations['Dutse'], flight_date: 1.day.from_now, airport: saved_airports['Nnamdi Azikwe International Airport'], airline: saved_airlines['Nigerian Airways'], available_seats: 10 },
  { destination: saved_locations['Enugu'], flight_date: 1.day.from_now, airport: saved_airports['Nnamdi Azikwe International Airport'], airline: saved_airlines['Asiana'], available_seats: 10 },
  { destination: saved_locations['Kano'], flight_date: 2.day.from_now, airport: saved_airports['Nnamdi Azikwe International Airport'], airline: saved_airlines['Swiss International Air Lines'], available_seats: 10 },
  ...
  { destination: saved_locations['Calabar'], flight_date: 5.day.from_now, airport: saved_airports['Mallam Aminu Kano International Airport'], airline: saved_airlines['Nigerian Airways'], available_seats: 10 },
  ...
  { destination: saved_locations['Abuja'], flight_date: 1.day.from_now, airport: saved_airports['Murtala Muhammed International Airport'], airline: saved_airlines['Asiana'], available_seats: 10 },
  { destination: saved_locations['Dutse'], flight_date: 1.day.from_now, airport: saved_airports['Murtala Muhammed International Airport'], airline: saved_airlines['Nigerian Airways'], available_seats: 10 },
  { destination: saved_locations['Enugu'], flight_date: 1.day.from_now, airport: saved_airports['Murtala Muhammed International Airport'], airline: saved_airlines['Asiana'], available_seats: 10 },
  { destination: saved_locations['Kano'], flight_date: 2.day.from_now, airport: saved_airports['Murtala Muhammed International Airport'], airline: saved_airlines['Swiss International Air Lines'], available_seats: 10 },
